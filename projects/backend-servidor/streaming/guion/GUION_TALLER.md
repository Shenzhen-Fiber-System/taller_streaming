...
> **Mostrar Slide: Roadmap del Taller**
>
> *"Para que sepan dónde estamos parados:*
>
> 1.  **👉 JORNADA 1 (HOY): Backend Reactivo.** *Vamos a construir los cimientos. Base de datos, API y Estado del Stream.*
> 2.  **JORNADA 2: WebRTC y Video.** *Conectaremos los cables reales. Janus, FFmpeg y ver video en el navegador.*
> 3.  **JORNADA 3: Flutter.** *La app móvil para transmitir desde el celular.*"
...
> **Mostrar Slide: Roadmap del Taller**
>
> *Repasemos nuestro mapa:*
>
> 1.  **✅ JORNADA 1:** *Backend Reactivo listo (R2DBC + CRUD).*
> 2.  **👉 JORNADA 2 (HOY): WebRTC y Pipeline de Video.** *Hoy hacemos magia. Vamos a ver video real fluyendo.*
> 3.  **JORNADA 3:** *Flutter (Cliente Móvil).*
>
> *Hoy el objetivo es claro: Salir de aquí viendo un stream en vivo en nuestro navegador."*

### 🗣️ Recap + Demo del Servidor Central
